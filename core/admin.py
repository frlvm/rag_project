...
from .models import Course, Institute, StudentProfile, Subject, TeacherProfile, User
...
class StudentProfileAdmin(CSVUploadMixin, admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Образование", {"fields": ("course", "subjects", "institute")}),
    )
...
class CourseAdmin(admin.ModelAdmin):
    ...
    ordering = ["number"]
    fieldsets = (
        (None, {"fields": ("number", "level", "description")}),
    )
...
class SubjectAdmin(admin.ModelAdmin):
    ...
    ordering = ["name"]
    fieldsets = (
        (None, {"fields": ("name", "teacher")}),
        ("Детали", {"fields": ("course", "institute")}),
    )
