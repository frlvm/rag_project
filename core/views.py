...
from .models import ChatMessage, Document, StudentProfile, Subject, TeacherProfile, TextChunk, User
...
def delete_document(request, doc_id):
    ...
    messages.success(request, f"Документ удалён. Чанков: {deleted_count}")
...
def add_subject_for_student(request):
    ...
    return render(request, "core/add_subject_student.html", {"subjects": allowed_subjects})
